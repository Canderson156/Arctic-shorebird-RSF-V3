...
#### I haven't updated since I created g2c, 10 plots that are points in line, 
# but I'm not sure if it is necessary, not sure if this script creates anything I will use
